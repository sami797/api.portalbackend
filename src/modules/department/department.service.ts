...
export class DepartmentService {
  ...
  findAll(filters: Prisma.DepartmentWhereInput, pagination: Pagination) {
  ...
  findAllPublished(filters: Prisma.DepartmentWhereInput, pagination: Pagination) {
    let skip = (pagination.perPage * (pagination.page - 1));
    let take = pagination.perPage;
  ...
  update(id: number, updateDto: UpdateDepartmentDto) {
  ...
  applyFilters(filters: DepartmentFiltersDto) {
    let condition: Prisma.DepartmentWhereInput = {
      isDeleted: false
    };
  ...
  countFaqs(filters: Prisma.DepartmentWhereInput) {
